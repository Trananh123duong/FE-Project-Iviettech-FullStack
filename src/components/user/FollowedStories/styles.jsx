...
export const Wrapper = styled.div`
  ...
  /* ===== Mobile (<= sm) – nút tròn “nổi” bên phải ===== */
  @media (max-width: ${bp.sm}) {
    padding: 8px;
    border-radius: 7px;
    overflow: hidden; /* clip theo bo góc */

    .ant-list-item {
      position: relative;
      gap: 8px;
      padding: 8px 48px 8px 8px; /* chừa chỗ cho nút nổi */
      box-sizing: border-box;
      flex-wrap: nowrap; /* giữ 1 hàng gọn */
    }
    ...
    /* Ẩn nhãn text, chỉ giữ icon (đúng DOM AntD v5) */
    .ant-list-item-action .ant-btn > span:not(.ant-btn-icon),
    .ant-list-item-action .ant-popover-open.ant-btn > span:not(.ant-btn-icon) {
      display: none;
    }
  ...
  /* ===== Reset ≥ 481px: trả về layout mặc định, tránh “một nút” ở ~600px ===== */
